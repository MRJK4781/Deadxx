...
from pyrogram.types import (
    ...
    Message, InputMediaPhoto, InputMediaVideo, InputMediaPhoto
)
...
async def settings_back_markup(client, CallbackQuery: CallbackQuery, _):
    ...
    if CallbackQuery.message.chat.type == ChatType.PRIVATE:
        ...
        return await CallbackQuery.edit_message_media(media=InputMediaPhoto(START_IMG_URL, caption=_["start_2"].format(CallbackQuery.from_user.mention, app.mention)),
            reply_markup=InlineKeyboardMarkup(buttons),
        )
    else:
        buttons = setting_markup(_)
